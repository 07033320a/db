...
-- ----------------------------
BEGIN;
INSERT INTO `course_student` VALUES ('12', '45', '10003', '2018-12-02 11:06:27', '2018-12-02 11:21:16', '0', null, null, '2'), ('13', '45', '10003', '2018-12-02 11:24:10', '2018-12-02 11:24:10', '0', null, null, '1'), ('14', '26', '10003', '2018-12-02 11:40:56', '2018-12-02 11:40:56', '0', null, null, '1');
COMMIT;
...
CREATE TABLE `course_teacher` (
  ...
  `end_date` datetime DEFAULT NULL COMMENT '结束时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='发布号作者表';

-- ----------------------------
--  Records of `course_teacher`
-- ----------------------------
BEGIN;
INSERT INTO `course_teacher` VALUES ('5', '莎士比亚1', '2017-10-25 09:08:45', '2018-12-02 10:30:01', '2', '美方向移民发射催泪弹（图源：路透社）\n\n海外网11月27日电随着大批中美洲移民抵达美墨边境的墨西哥一侧，试图越过围栏进入美国，美方也在上周末起采取一系列强硬措施，包括对移民发射催泪弹，随即引发一些移民权利组织的不满。当地时间26日，美国总统特朗普为美边境巡逻队使用催泪弹的做法辩护，直指一些移民“非常粗暴”，美方是“不得已采取了这样的行动”。\n\n', null, '100', '2', 'wed,thu', '10003', '10003', null, null, '2', null, null, null, null), ('6', 'KKK', '2017-10-26 10:49:28', '2018-12-02 10:37:16', '25', '12', null, '1', '2', 'tue,wed', '10003', '10003', null, null, '2', null, null, null, null), ('19', '文章test2', '2017-11-18 13:37:07', '2018-12-02 10:37:14', '25', '烦烦烦', null, '111', '2', 'tue,wed,thu', '10003', '10003', null, null, '2', null, null, null, null), ('20', '劳斯莱斯了', '2018-11-21 14:07:19', '2018-12-02 10:37:12', '25', '12', null, '1999', '2', 'tue,thu', '10003', '10003', null, null, '2', null, null, null, null), ('23', '反反复复2反反复复', '2018-11-21 14:07:34', '2018-12-02 08:41:18', '25', 'sdafsadfasdf', null, '509', '2', 'wed', '10008', '10003', null, null, '1', null, null, null, null), ('24', '1212', '2018-11-21 14:07:42', '2018-12-02 08:41:31', '25', '方法', null, '400', '2', 'tue', '10008', '10003', null, null, '1', null, null, null, null), ('25', '发发发', '2018-11-21 14:07:47', '2018-12-02 08:41:49', '25', '综合福克斯新闻、美国中文网等媒体报道，26日，特朗普在白宫外对记者发表讲话时谈及了近日引发诸多关注的移民问题。对于美国边境巡逻队上周末使用催泪弹驱逐一群冲向边境的大篷车移民，特朗普表示：“他们（边境巡逻队）不得不使用催泪瓦斯，因为冲向他们的是一些非常粗暴的人。正因为如此，他们使用了催泪瓦斯。（我们的）底线就是：除非合法进入，否则没人可以进入美国。”\n\n除了特朗普，此次事件的当事方——圣地亚哥边境巡逻队主管斯科特26日也在接受媒体采访时谈及了当时的情况。他表示，移民走近边境围栏后开始向移民官员投掷石块和碎片。“我们的人受到攻击，而他们的数量开始增长，你知道我们两到三个人要面对数百人，所以就使用催泪瓦斯来保护自己。”\n\n不过，美国公民自由联盟移民权利项目副主任格伦特却认为，边境巡逻队是在“过度使用武力”。“那里有妇女和儿童。在这种情况下使用催泪瓦斯似乎并不合理。”格伦特说。\n聚集在美墨边境的移民（图源：路透社）\n\n此前，美媒曾报道特朗普就“移民大军”向墨西哥“发难”，要求墨方将那些想在美国申请庇护的移民送回本来的国家，否则就会在必要时永久关闭美墨边境。墨西哥政府尚未对此作出回应。\n\n连日来，大批中美洲移民在墨西哥的边境城市聚集，寻求进入美国，美墨两国也纷纷在边境地区加派兵力展开应对。在周末的骚乱发生后，墨西哥方面表示将立即驱逐大约500名非法越境的移民。墨西哥还表示，自10月19日以来，已将1.1万名中美洲移民送回原籍国，其中有1906名是近期大篷车队的成员。（海外网 张霓）\n\n本文系版权作品，未经授权严禁转载。海外视野，中国立场，登陆人民日报海外版官网——海外网www.haiwainet.cn或“海客”客户端，领先一步获取权威资讯。\n本文由百家号作者上传并发布，百家号仅提供信息发布平台。文章仅代表作者个人观点，不代表百度立场。未经作者许可，不得转载。\n本文由百家号作者上传并发布，百家号仅提供信息发布平台。文章仅代表作者个人观点，不代表百度立场。未经作者许可，不得转载。\n本文由百家号作者上传并发布，百家号仅提供信息发布平台。文章仅代表作者个人观点，不代表百度立场。未经作者许可，不得转载。\n聚集在美墨边境的移民（图源：路透社）\n\n此前，美媒曾报道特朗普就“移民大军”向墨西哥“发难”，要求墨方将那些想在美国申请庇护的移民送回本来的国家，否则就会在必要时永久关闭美墨边境。墨西哥政府尚未对此作出回应。\n\n连日来，大批中美洲移民在墨西哥的边境城市聚集，寻求进入美国，美墨两国也纷纷在边境地区加派兵力展开应对。在周末的骚乱发生后，墨西哥方面表示将立即驱逐大约500名非法越境的移民。墨西哥还表示，自10月19日以来，已将1.1万名中美洲移民送回原籍国，其中有1906名是近期大篷车队的成员。（海外网 张霓）\n\n本文系版权作品，未经授权严禁转载。海外视野，中国立场，登陆人民日报海外版官网——海外网www.haiwainet.cn或“海客”客户端，领先一步获取权威资讯。', null, null, '2', 'thu', '10008', '10003', null, null, '1', null, null, null, null), ('26', '1test12', '2018-11-23 13:51:01', '2018-12-01 21:32:22', '25', '反反复复', null, '45', '2', 'wed,thu', '10008', '10003', null, null, '1', null, null, null, null), ('27', 'eer', '2018-11-27 16:29:39', '2018-12-02 10:37:11', '25', '12', null, '12', '2', 'wed,thu', '10003', '10003', null, null, '2', null, null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('32', '22', '2018-11-29 17:25:08', '2018-12-02 10:37:09', '25', '12', null, '12', '2', 'wed,thu', '10003', '10003', '1', null, '2', '[2,7]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('33', '1212', '2018-12-01 14:41:26', '2018-12-02 10:35:59', '25', '12', null, null, '2', 'wed,thu', '10003', '10003', null, null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('34', '121', '2018-12-01 14:41:58', '2018-12-02 10:30:59', '25', '12', null, null, '2', 'wed,thu', '10003', '10003', null, null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('35', 'w22', '2018-12-01 15:42:31', '2018-12-02 10:35:56', '25', '12', null, null, '2', 'wed,thu', '10003', '10003', null, null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('36', '哥哥', '2018-12-01 16:30:48', '2018-12-02 10:35:53', '25', '12', 'fee', '1212', '2', 'wed,thu', '10003', '10003', '1', null, '2', '[0,7]', '12', '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('37', '12hhhhhh', '2018-12-01 17:07:18', '2018-12-02 10:31:04', '25', '12', 'fee', '12', '2', 'wed,thu', '10003', '10003', '2', null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('38', 'ooooooooooo', '2018-12-01 17:50:21', '2018-12-02 10:35:50', '20', '12112', 'fee', '111', '2', 'tue,wed,thu', '10003', '10003', '2', null, '2', '[9,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('39', '12', '2018-12-01 20:21:38', '2018-12-02 10:35:47', '25', '12', 'fee', '12', '3', 'tue,wed,thu', '10003', '10003', '1', null, '2', '[9,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('40', 'lllll', '2018-12-01 21:26:47', '2018-12-02 10:35:43', '25', '21', 'free', null, null, 'wed,thu', '10003', '10003', '2', null, '2', '[2,2]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('41', '777777', '2018-12-01 21:31:09', '2018-12-02 10:35:39', '25', '2w', 'free', null, null, 'tue,wed,thu', '10003', '10003', '1', null, '2', '[6,6]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('42', '00000000000', '2018-12-02 09:21:17', '2018-12-02 10:34:26', '25', 'kkk', 'free', null, null, 'tue', '10003', '10003', '1', null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('43', '00000000000', '2018-12-02 09:39:21', '2018-12-02 10:34:36', '25', 'kkk', 'free', null, null, 'tue,wed', '10003', '10003', '1', null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('44', '00000000000', '2018-12-02 09:46:17', '2018-12-02 10:35:25', '25', 'kkk', 'free', null, null, 'tue,wed', '10003', '10003', '1', null, '2', '[0,9]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00'), ('45', 'fffff', '2018-12-02 10:37:41', '2018-12-02 11:10:43', '25', '反倒是', 'free', null, null, 'tue,wed', '10003', '10003', '1', null, '1', '[0,7]', null, '2018-11-07 00:00:00', '2018-11-24 00:00:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES ('1', '管理员', '2017-11-22 16:24:34', '2018-11-21 15:37:15', '1', '2', null), ('2', '作家', '2017-11-22 16:24:34', '2018-11-23 13:19:04', '1', '2', '2'), ('3', '教师', '2017-11-22 16:28:47', '2018-11-23 13:19:03', '1', '1', '2'), ('4', '学生', '2018-11-20 09:49:12', '2018-11-30 11:42:31', '1', '2', '1'), ('5', 'test', '2018-11-23 13:18:30', '2018-11-27 17:31:09', '2', '1', '2');
COMMIT;
